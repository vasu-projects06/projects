...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        setBounds(130, 50, 1100, 640);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("simplequiz/icons/dd.jpg"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(0, 0, 1100, 210);
        add(l1);
        
        qno = new JLabel("");
        qno.setFont(new Font("Tahoma", Font.PLAIN, 25));
        qno.setBounds(100, 260, 50, 30);
        add(qno);
        
        question = new JLabel("");
        question.setFont(new Font("Tahoma", Font.PLAIN, 25));
        question.setBounds(150, 260, 1000, 30);
        add(question);
        ...
        lifeline.setBounds(840, 435, 160, 35);
        add(lifeline);
        ...
        submit.setBounds(840, 500, 160, 35);
        add(submit);
    ...
    public void paint(Graphics g){
        ...
        if(timer > 0) {
            g.drawString(time, 880, 350);
        }else {
            g.drawString("Times Up !!", 880, 350);
        }
